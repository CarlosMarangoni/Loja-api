...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/api/clientes/cadastrar").permitAll()
				...
				.antMatchers(HttpMethod.POST, "/api/**").hasAnyAuthority("LOJA").antMatchers(HttpMethod.GET, "/api/**")
				.hasAnyAuthority("LOJA").antMatchers(HttpMethod.PUT, "/api/**").hasAnyAuthority("LOJA")
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**"); //Liberando o Swagger
	}
}
